...
export const profileSchema = z.object({
  ...
  employment_type: z.nativeEnum(EmploymentType).nullable().optional(),
  employed_in: z.string().nullable().optional(),
  annual_income: z.nativeEnum(AnnualIncome).nullable().optional(),
